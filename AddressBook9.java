...
public class AddressBook9 {
	public static void main(String[] args) {
		...
		Collection<AddressBookUC9> c = new ArrayList<AddressBookUC9>();
		Collection<AddressBookUC9> c1 = new ArrayList<AddressBookUC9>();
		...
		do {
			...
			case 1:
				...
				Iterator<AddressBookUC9> i = c.iterator();
				while(i.hasNext()) {
					AddressBookUC9 e = i.next();
				...
				if(opt == 1) {
					c.add(new AddressBookUC9(firstName, lastName, address, state, zip, phoneNumber, eMail));
				}
				if(opt == 2) {
					c1.add(new AddressBookUC9(firstName, lastName, address, state, zip, phoneNumber, eMail));
				}
				break;
			case 2:
				System.out.print("1.Book_1 \n2.Book_2 \nChoose the Address Book : ");
			...
			case 3:
				...
				if(opt == 1) {
					...
					phoneNumber =  scan1.nextLong();
					ListIterator<AddressBookUC9> li =  ((ArrayList<AddressBookUC9>) c).listIterator();
					while(li.hasNext()) {
						AddressBookUC9 e = li.next();
						if(e.getPhoneNumber() == phoneNumber) {
							...
							eMail = scan.nextLine();
							System.out.print("1.Book_1 \n 2.Book_2 \n Choose the Address Book : ");
							li.set(new AddressBookUC9(firstName, lastName , address, state, zip, phoneNumber, eMail));
							found = true;
						}
					}
				}
				if(opt == 2) {
					System.out.print("Enter the Phone Number to Edit the contact: ");
					phoneNumber =  scan1.nextLong();
					ListIterator<AddressBookUC9> li =  ((ArrayList<AddressBookUC9>) c1).listIterator();
					while(li.hasNext()) {
						AddressBookUC9 e = li.next();
						if(e.getPhoneNumber() == phoneNumber) {
							System.out.print("Enter new First Name : ");
			...
			case 5:
				...
				state = scan.nextLine();
				i = c.iterator();
				Iterator<AddressBookUC9> i1 = c1.iterator();
